...
class FCACTIONSOPERATOR_API FCGraphEventOperator : public FCAbstractOperator
{
    Q_OBJECT
public:
    explicit FCGraphEventOperator() = default;
    virtual ~FCGraphEventOperator();
    
    /**
     * @brief 据提供的数据对象ID更新对应可视化对象
     * @param dataObjId
     * @param forceUpdate
     */
     ...
     * @return  可视化对象
     */
    virtual FCVTKGraphObject3D* getModelGraphObjectByDataId(int dataObjId);
