 ...
 * @brief 多截面曲面
 */
class FCGEOMETRYINTERFACE_API FCGeoModelMultiSectionSurface : public FCGeoModelSurface
{
    FC_CLASS(FC, FCGeoModelMultiSectionSurface);
public:
    ...
    QList<VirtualShape> guides() const { return m_guides; }
    void setGuides(const QList<VirtualShape>& g) { m_guides = g; }
protected:
    QList<VirtualShape> m_sections;
    QList<VirtualShape> m_guides;
};

/**
 * @brief 桥接曲面
 */
class FCGEOMETRYINTERFACE_API FCGeoModelBridgeSurface : public FCGeoModelSurface
{
    FC_CLASS(FC, FCGeoModelBridgeSurface);
public:
    ...
    void setSourceSurface2(VirtualShape s) { m_sourceSurface2 = s; }
...
protected:
    ...
    int m_edgeVirtualTopoId1{ -1 };
    int m_edgeVirtualTopoId2{ -1 };
};

/**
 * @brief 体的面（从实体取面）
 */
class FCGEOMETRYINTERFACE_API FCGeoModelSolidSurface : public FCGeoModelSurface
{
    FC_CLASS(FC, FCGeoModelSolidSurface);
public:
...
protected:
    VirtualShape m_solid;
    int m_faceVirtualTopoId{ -1 };
};
