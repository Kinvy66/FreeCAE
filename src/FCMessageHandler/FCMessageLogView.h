 ...
 */
#ifndef FCMESSAGELOGVIEW_H
#define FCMESSAGELOGVIEW_H
...
namespace FC 
{
class FCMessageLogModel;
class FCMessageLogsSortFilterProxyModel;

class FCMESSAGEHANDLER_API FCMessageLogView : public QWidget
{
    Q_OBJECT
    
public:
    explicit FCMessageLogView(QWidget *parent = nullptr);
    ~FCMessageLogView();
...
private:
    Ui::FCMessageLogView *ui;
    FCMessageLogModel* _model;
